function PortfolioComponent() {
    return (
        <div className="col-span-4 group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-transparent dark:border-gray-700 dark:shadow-neutral-700/70">
            ...
            <div className="mt-auto flex border-t border-gray-200 divide-x divide-gray-200 dark:border-gray-700 dark:divide-neutral-700">
                <a className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-b-lg bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-800 dark:border-gray-700 dark:text-white dark:hover:bg-neutral-800" href="#">
                    View sample
                </a>
            </div>
        </div>
