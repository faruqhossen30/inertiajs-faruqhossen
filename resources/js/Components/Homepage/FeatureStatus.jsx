            ...
            <div className="grid items-center lg:grid-cols-12 gap-6 lg:gap-12">
                ...
                <div className="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-left-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200 lg:before:dark:bg-gray-700">
                    <div className="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
                        ...
                        <div>
                            <p className="text-3xl font-semibold text-blue-500">1,000+</p>
                        ...
                        <div>
                            <p className="text-3xl font-semibold text-blue-500">200+</p>
                            <p className="mt-1 text-gray-500">Projets completed</p>
                        </div>



                        <div>
                            <p className="text-3xl font-semibold text-blue-500">8</p>
                            <p className="mt-1 text-gray-500">Yesars of exprience</p>
                        </div>
